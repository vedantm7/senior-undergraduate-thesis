...
#SBATCH --job-name=fresh_ma_8.0
#SBATCH --output=/home/mundhra.ve/poker_thesis/calibration/maniac/fresh_8.0/job.log
#SBATCH --error=/home/mundhra.ve/poker_thesis/calibration/maniac/fresh_8.0/job.err
...
/home/mundhra.ve/poker_thesis/open-pure-cfr-buckets/pure_cfr \
    ...
    /home/mundhra.ve/poker_thesis/calibration/maniac/fresh_8.0/strategy \
    --card-abs=FILE:/home/mundhra.ve/poker_thesis/holdem_100b_cfrm.abs \
    --threads=48 \
    --checkpoint=3600 \
    --max-walltime=04:23:00:00 \
    --config=/home/mundhra.ve/poker_thesis/calibration/maniac/fresh_8.0/params.conf
